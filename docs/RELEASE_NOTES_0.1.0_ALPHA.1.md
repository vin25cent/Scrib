...
Première version installable destinée aux essais privés sur Apple Silicon.

## Inclus

- création et enregistrement segmenté d’un cours ;
...
Cette alpha n’est pas notarée. Suivre le

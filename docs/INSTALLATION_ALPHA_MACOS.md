# Installer Scrib 0.1.0-alpha.5 sur macOS
...
1. Ouvrir la page [Scrib 0.1.0-alpha.5](https://github.com/vin25cent/Scrib/releases/tag/v0.1.0-alpha.5).
2. Dans **Assets**, télécharger `Scrib-0.1.0-alpha.5-macOS.zip`.

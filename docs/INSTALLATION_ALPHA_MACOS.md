# Installer Scrib 0.1.0-alpha.3 sur macOS
...
1. Ouvrir la page [Scrib 0.1.0-alpha.3](https://github.com/vin25cent/Scrib/releases/tag/v0.1.0-alpha.3).
2. Dans **Assets**, télécharger `Scrib-0.1.0-alpha.3-macOS.zip`.
